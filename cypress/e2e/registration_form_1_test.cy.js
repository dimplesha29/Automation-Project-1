...
describe('This is first test suite, Dimple Sharma', () => {
   ""
   /*26/05/2024 */
    it('User can submit data only when valid mandatory values are added', () => {
        
        cy.get('[data-testid="phoneNumberTestId"]').type('555666777')
        cy.get('input[name="password"]').type('Abcd12347')
        cy.get('[name="confirm"]').type('Abcd12347')
    ...
    it('User can use only same both first and validation passwords', () => {
        ...
        cy.get('input[name="password"]').type('Password2727')
        cy.get('[name="confirm"]').type('Password2728')
    ...
    */
    ...
    it('User cannot add letters to phone number', () => {
        cy.get('#username').type('johnDoe')
        cy.get('[data-testid="phoneNumberTestId"]').type('abcde')
        cy.get("input[name='password']").type('Password123')
        cy.get('[name="confirm"]').type('Password123')
